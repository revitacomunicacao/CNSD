...
import { IBiblioteca } from "./types/IBiblioteca"
...
export default function Biblioteca() {
  useSeo({
    title: "Biblioteca - CNSD",
    description: "Conheça a biblioteca do Colégio Nossa Senhora das Dores",
  })

  const { data: biblioteca, loading, error } = useContent<IBiblioteca>("atividades/biblioteca")
  ...
  return (
    <main>
      {biblioteca.map(({ id, titulo, conteudo, galeria_de_foto, link_video }) => {
            ...
            <section className="w-full max-w-[1200px] flex flex-col gap-10 md:gap-10 px-4">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="text-lg text-gray-700">
                  De segunda a sexta-feira das 8h às 17h30, com intervalo das 12h00 às 13h.
                </p>
              </div>
