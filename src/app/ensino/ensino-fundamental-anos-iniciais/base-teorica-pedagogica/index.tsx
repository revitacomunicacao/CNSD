...
export default function BaseTeoricaAnosIniciais() {
  useSeo({
    title: "Base Teórica-Pedagógica - Ensino Fundamental Anos Iniciais - CNSD",
    description: "Conheça a base teórica-pedagógica do Ensino Fundamental Anos Iniciais do Colégio Nossa Senhora das Dores",
  })
  const { data: baseTeorica, loading, error } = useContent<IBaseTeorica>("ensino/ensino-fundamental-anos-iniciais-base-teorica-pedagogica")
