...
export default function BaseTeoricaPedagogica() {
  useSeo({
    title: "Base Teórica-Pedagógica - Ensino Técnico - CNSD",
    description: "Conheça a base teórica-pedagógica do Ensino Técnico do Colégio Nossa Senhora das Dores",
  })
  const { data: baseTeorica, loading, error } = useContent<IBaseTeorica>("ensino/ensino-tecnico-base-teorica-pedagogica")
