...
export default function BaseTeoricaPedagogica() {
  useSeo({
    title: "Base Teórica-Pedagógica - Ensino Médio - CNSD",
    description: "Conheça a base teórica-pedagógica do Ensino Médio do Colégio Nossa Senhora das Dores",
  })
  const { data: baseTeorica, loading, error } = useContent<IBaseTeorica>("ensino/ensino-medio-base-teorica-pedagogica")
